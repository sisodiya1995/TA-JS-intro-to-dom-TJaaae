...
//    - Select the first `li` element inside the `ul` with class `topics` and change the innerText to `all about document`
     ...
     let selectUl = document.querySelector('ul');
       selectUl.firstElementChild.innerText = "all about document";
...
// 17. Select all the buttons and log the count of buttons.
  ...
  console.log(`total button is ${buttonsAll.length}`);
// 18. Select all the `label` element and log the count.la
let allLabels = document.querySelectorAll('label');
console.log(`total label count is ${allLabels.length}`) ;
...
// 23. Select the previous element sibling of the element stored in `topics` variable (#5) and change the `innerText` property to `Learning About Walking the DO
