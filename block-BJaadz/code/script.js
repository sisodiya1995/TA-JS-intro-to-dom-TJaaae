...
// Set the border of the all the hr elements to "1px solid tomato"
 //allHrs.style.borderStyle = "1px solid tomato";
// Change the background of all the hr to "antiquewhite" using for of loop.
for(let hrt of allHrsArray){
 hrt.style.background = "antiquewhite";
}
...
let box1 = document.querySelector(".one");
 ...
 let box1d = box1.children[0].remove();
...
let newFCP = document.createElement('p');
newFCP.innerText = "Prepend inserts as first child"
